...
This is a living, vendor-neutral list of AEO tracking tools. Corrections and additions are welcome.

## How to add or fix a tool

1. Edit [tools.yaml](tools.yaml). Each entry has these fields:
   - `name`, `url` (optional), `category`, `engines`, `free`, `price_from`, `best_for`
